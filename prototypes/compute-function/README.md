...
При изменении payload-файлов версия `?v=` в `index.html` должна обновляться одновременно: это не позволяет браузеру смешать закешированные части разных сборок.
